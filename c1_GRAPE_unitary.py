...
target_list = ["projbinomial04D6_rev"] 
save_path_list = target_list

#recall the Um
D = 6
Um = np.load(r'C:\Users\tanju\Dropbox\PY\OREO\Matrix_Um.npz')['Um']
U_tar = (Um.T.conj())[0:D,0:D]
...
if __name__ == "__main__":
    ...
    for i in range(len(save_path_list)):
        ...
        # Initialise pulses
        num_ctrls = 4 #if target == 'pi_pulse' or target == 'coherent' else 4
