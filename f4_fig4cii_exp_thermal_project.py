...
filepath = r"C:\Users\tanju\Dropbox\PY\Data\OREO\fig4 data\sparsewigner_thermal_proj\01-06-06_StateProjectionSparseWigner2D.hdf5"


def read_hdf5_file(file_path):
    with h5py.File(file_path, "r") as hdf:
        data_preselect_0 = hdf["preselect_0"]
...
for phase in range(2):
    data_preselect_0 = data_preselect_0_all[:, :, phase]
    ...
    for c1 in range(data_preselect_1.shape[1]):
        ...
        data_preselect_0_column = data_preselect_0[:, c1]
        ...
        data_selected_0 = np.array(
            [
                ...
                if (
                    ...
                    and (data_preselect_0_column[i] == 0)
                )
            ]
        )
...
np.savez('rho_thermal_proj_f0p4.npz', rho=qRho_est)#save the ideal values
