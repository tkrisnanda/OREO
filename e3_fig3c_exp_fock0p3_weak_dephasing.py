...
filepath = r"C:\Users\tanju\Dropbox\PY\Data\OREO\fig3 data\sparsewigner0p3\21-44-06_SparseWignerD6.hdf5"
...
data_preselect_all, data_preselect_cav_all, data_single_shot_all, disp_id = (
...
for phase in range(2):
    ...
    for c1 in range(data_preselect_1.shape[1]):
        ...
        p = np.average(data_selected_0)#[:90])  # "P(1|0)"
        p_is.append(p)
...
np.savez('rho_f0p3_weak_dephasing.npz', rho=qRho_est)#save the ideal values
