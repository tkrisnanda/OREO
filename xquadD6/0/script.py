#%%
import sys
sys.path.append("/Users/tanjungkrisnanda/Library/CloudStorage/Dropbox/PY/OREO/grape")
sys.path.append("/Users/tanjungkrisnanda/Library/CloudStorage/Dropbox/PY/OREO/grape/pygrape")
from pygrape import *
from qutip import *
...
new_directory = "/Users/tanjungkrisnanda/Library/CloudStorage/Dropbox/PY/OREO"
...
D = 6#truncation dimension
a = destroy(15)#define operator in higher dimension before truncation
x = (a+a.dag())/np.sqrt(2)
# x = -1j*(a-a.dag())/np.sqrt(2)
# x = x*x
x = Qobj(x[0:D,0:D])#truncate
xnorm = x/(np.max(np.linalg.eigvals(x.full())))#scale [-1,1]
Gtar = xnorm.full()#target observable
...
def make_setup(
    ...
    setup = ObservableSetup_new_geonly(
        H0, Hc,
        Gtar, cdim)
