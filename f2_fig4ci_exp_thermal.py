...
filepath = r"C:\Users\tanju\Dropbox\PY\Data\OREO\fig4 data\sparsewigner_thermal\14-44-33_ThermalPreparationSparseWigner.hdf5"
...
data_preselect_all, data_single_shot_all, disp_id = read_hdf5_file(filepath)
    ...
    for c1 in range(data_preselect_1.shape[1]):
        ...
        data_selected_0 = np.array(
            [
                ...
                if ((data_preselect_1_column[i] == 0))
            ]
        )
...
np.savez('rho_thermal.npz', rho=qRho_est)#save the ideal values
